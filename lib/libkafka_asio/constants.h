...
enum Defaults
{
  ...
  kDefaultProducerMaxRetries = 2,
  kDefaultProducerRetryBackoffTime = 100,
  kDefaultProducerQueueBufferingMaxMessages = 100000,
  kDefaultProducerQueueBufferingMaxMs = 500,
  kDefaultProducerBatchMaxMessages = 1000,
  kDefaultProducerDeliveryReportErrorsOnly = true,
